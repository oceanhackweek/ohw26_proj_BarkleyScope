...
**Committed** — everything you need is here after a clone:
...
PNG rewritten on every run is the history bloat `data/README.md` warns about. Same rule
as `data/sst/.gitignore`.

| File | From |
|---|---|
| `sst_vs_folger_four_panel.png` | `python make_comparison.py` |
| `preview_compare_points.png` | `python preview_compare_points.py` |
